...
<div style="margin-top: 24px;" class="container">
    ...
    <form style="margin-top: 24px;" action="?controller=admin&action=updateProduct&product_id=<?php echo $product['product_id']?>" method="post" enctype="multipart/form-data">
        <label for="name">Nhập tên sản phẩm:</label>
        <input required type="text" id="name" name="name" value="<?php echo $product['name']?>"><br><br>

        <label for="price">Giá:</label>
        <input required type="text" id="price" name="price" value="<?php echo $product['price']?>"><br><br>
